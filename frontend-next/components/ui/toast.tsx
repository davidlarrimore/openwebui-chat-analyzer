...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close ref={ref} className={cn(buttonVariants({ variant: "ghost" }), "absolute right-2 top-2", className)} {...props} />
));
...
export { ToastProvider, ToastViewport, Toast, ToastTitle, ToastDescription, ToastClose, ToastAction, type ToastActionElement };
