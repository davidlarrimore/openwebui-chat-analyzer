...
class Chat(BaseModel):
    ...
    Attributes:
        ...
        gen_chat_summary: Locally generated summary string (preferred field).
        summary_128: Legacy ≤128 character summary retained for backwards compatibility.
    ...
    gen_chat_summary: Optional[str] = Field(
        default=None,
        description="Canonical conversation summary generated by the analyzer",
    )
    ...
    def _synchronize_summary_fields(cls, values: Any) -> Any:
        """Ensure gen_chat_summary and summary_128 stay aligned."""
        ...
        summary_preferred = _normalize(values.get("gen_chat_summary"))
        summary_legacy = _normalize(values.get("summary_128"))

        canonical = summary_preferred or summary_legacy
        if canonical:
            values["gen_chat_summary"] = canonical
            values["summary_128"] = canonical[:128]
        else:
            values["gen_chat_summary"] = None
            if "summary_128" in values:
                values["summary_128"] = None
